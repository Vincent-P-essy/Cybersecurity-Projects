...
***Contact - [Vincent.plessy12@gmail.com](mailto:Vincent.plessy12@gmail.com)***
...
**Repository:** [https://github.com/Vincent-P-essy/Cybersecurity-Projects](https://github.com/Vincent-P-essy/Cybersecurity-Projects)
...
Format your code using the repository's custom YAPF configuration. Copy the [.style.yapf](https://github.com/Vincent-P-essy/Cybersecurity-Projects/blob/main/TEMPLATES/.style.yapf) file and place it in the root of your project directory.
```bash
...
**[Fullstack Template](./TEMPLATES/fullstack-template)** - A production-ready template with FastAPI, React, Docker, and more. Check the [GitHub repository](https://github.com/Vincent-P-essy/fullstack-template) for the latest updates.
...
1. Navigate to the [original repository](https://github.com/Vincent-P-essy/Cybersecurity-Projects)
...
If you have questions about contributing or want to discuss a project idea before starting, [open an issue](https://github.com/Vincent-P-essy/Cybersecurity-Projects/issues) for discussion.
