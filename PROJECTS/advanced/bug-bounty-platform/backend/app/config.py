...
class Settings(BaseSettings):
    ...
    APP_SUMMARY: str = "Developed Vincent Plessy"
    APP_DESCRIPTION: str = "FastAPI async first boilerplate - JWT, Asyncdb, PostgreSQL"
    APP_CONTACT_NAME: str = "Vincent Plessy"
    APP_CONTACT_EMAIL: str = "Vincent.plessy12@gmail.com"
    APP_LICENSE_NAME: str = "MIT"
    APP_LICENSE_URL: str = "https://github.com/Vincent Plessy/Cybersecurity-Projects/blob/main/LICENSE"
